...
Value (Copyable/Movable) concept. Authors of \ref adobe::poly classes must derive their interfaces
from
...
/*!
  \ingroup poly_related
  \brief Authors of \ref adobe::poly concept representatives must derive their instance class from
  this.
  See of \ref adobe::poly_placeable_instance, for example. This metafunction is used in the
  implementation
